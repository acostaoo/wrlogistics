...
import 'package:WrLogistics/home/transport_bloc/transport_bloc.dart';
              ...
              if (state.status.isSuccess) {
                ...
                ScaffoldMessenger.of(context)
                  ...
                  ..showSnackBar(const SnackBar(
                      content: Text('Transporte creado con éxito !')));
                context.read<TransportBloc>().add(TransportFetched(
                    context.select((AppBloc bloc) => bloc.state.user.id)));
              } else if (state.status.isFailure) {
                ScaffoldMessenger.of(context)
                  ..hideCurrentSnackBar()
                  ..showSnackBar(SnackBar(
                      content:
                          Text(state.errorMessage ?? 'Creacción fallida')));
              }
            },
            child: Align(
                    ...
                    onPressed: state.isValid
                        ? () => context
                            ...
                            .createTransport(
                                ...
                                _PaymentMethodSelection.selectedPaymentMethod,
                                30000)
                        : null,
                    child: const Text(
                      'Crear Transporte',
